const { ArxivRLCrawler } = require('../arxiv-crawler');
...
describe('ArxivRLCrawler', () => {
  ...
  describe('Paper Fetching', () => {
        ...
        text: jest.fn().mockResolvedValue(`
          <feed xmlns="http://www.w3.org/2005/Atom">
            <entry>
              ...
              <summary>We propose GRPO, an enhancement to PPO using group-based normalization. This novel approach achieves state-of-the-art performance on continuous control benchmarks while improving sample efficiency. Our method incorporates theoretical proofs of convergence and demonstrates significant improvements over baseline PPO implementations.</summary>
              <author><name>John Doe</name><affiliation>OpenAI</affiliation></author>
              <author><name>Jane Smith</name><affiliation>Stanford University</affiliation></author>
    ...
    test('filters papers by RL keywords', () => {
      const mockPapers = [
      ...
      expect(titles).toContain('PPO for Robotics');
      expect(titles).toContain('Reinforcement Learning Survey');
    });
  ...
  describe('Batch Processing', () => {
    ...
    test('handles API errors gracefully', async () => {
      ...
      // First category fails then retries (2 calls), then 2 more categories
